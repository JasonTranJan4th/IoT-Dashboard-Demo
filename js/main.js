    ...
    btnElE.forEach((btn) => {
        btn.addEventListener('click', () => {
            ...
            window.setInterval(function handleLoadData() {
                ...
                const data2 = JSON.parse('{"ID":1,"Name":"Machine 2","Status":1,"Plan":3000,"Target":2000,"Actual":600,"NG":11,"OEE":{"Current":70.8,"IsInc":false,"PercentInc":-13.3,"Historical":[70.0,55.0,90.0,60.0,70.0,75.0,70.0,72.0,70.0,65.0]},"Availability":{"Current":85.0,"IsInc":false,"PercentInc":2.7,"Historical":[80.0,55.0,45.0,60.0,70.0,75.0,70.0,72.0,70.0,65.0]},"Performance":{"Current":86.4,"IsInc":false,"PercentInc":-15.4,"Historical":[60.0,65.0,45.0,69.0,70.0,75.0,76.0,72.0,88.0,65.0]},"Quality":{"Current":92.4,"IsInc":false,"PercentInc":-0.6,"Historical":[60.0,55.0,45.0,60.0,70.0,75.0,70.0,72.0,70.0,65.0]},"ProductionOrders":[{"No":"1","ID":"LSX-0006","ProductName":"Product 6","Target":105,"Actual":54,"NG":7,"Status":2},{"No":"2","ID":"LSX-0007","ProductName":"Product 7","Target":104,"Actual":54,"NG":6,"Status":2},{"No":"3","ID":"LSX-0008","ProductName":"Product 8","Target":104,"Actual":54,"NG":6,"Status":1},{"No":"4","ID":"LSX-0009","ProductName":"Product 9","Target":104,"Actual":54,"NG":6,"Status":0},{"No":"5","ID":"LSX-00010","ProductName":"Product 10","Target":107,"Actual":54,"NG":8,"Status":0}]}');
                const data3 = JSON.parse('{"ID":1,"Name":"Machine 3","Status":1,"Plan":4000,"Target":3000,"Actual":700,"NG":12,"OEE":{"Current":99.9,"IsInc":false,"PercentInc":-13.3,"Historical":[80.0,55.0,45.0,60.0,70.0,75.0,70.0,72.0,70.0,65.0]},"Availability":{"Current":85.0,"IsInc":true,"PercentInc":2.7,"Historical":[90.0,55.0,45.0,60.0,70.0,75.0,70.0,72.0,70.0,65.0]},"Performance":{"Current":86.4,"IsInc":false,"PercentInc":-15.4,"Historical":[60.0,65.0,45.0,69.0,70.0,75.0,76.0,72.0,88.0,65.0]},"Quality":{"Current":92.4,"IsInc":false,"PercentInc":-0.6,"Historical":[60.0,55.0,45.0,60.0,70.0,75.0,70.0,72.0,70.0,65.0]},"ProductionOrders":[{"No":"1","ID":"LSX-00011","ProductName":"Product 11","Target":105,"Actual":54,"NG":7,"Status":2},{"No":"2","ID":"LSX-00012","ProductName":"Product 12","Target":104,"Actual":54,"NG":6,"Status":2},{"No":"3","ID":"LSX-00013","ProductName":"Product 13","Target":104,"Actual":54,"NG":6,"Status":1},{"No":"4","ID":"LSX-00014","ProductName":"Product 14","Target":104,"Actual":54,"NG":6,"Status":0},{"No":"5","ID":"LSX-00015","ProductName":"Product 15","Target":107,"Actual":54,"NG":8,"Status":0}]}');
                ...
                oee.textContent = `${data.OEE.Current}%`;
                ...
                perform.textContent = `${data.Performance.Current}%`;
                ...
                avail.textContent = `${data.Availability.Current}%`;
                ...
                quanlity.textContent = `${data.Quality.Current}%`;
                    ...
                    for (let i = 0; i < data.ProductionOrders.length; i++) {
                        ...
                        for (let j = 0; j < liList.length; j++) {
                            ...
                            if (liEle) {
                                ...
                                if (keyValue === "Target" || keyValue === "Actual" || keyValue === "NG") {
